...
[source,sh,role="copypaste"]
----
curl http://localhost:8080/services/transactions | jq
----
...
[source,sh,role="copypaste"]
----
mvn -q quarkus:add-extension -Dextensions="jdbc-mysql,openshift" -f $CHE_PROJECTS_ROOT/fsi-workshop-v2m1-labs/transaction
----
...
✅ Extension io.quarkus:quarkus-jdbc-mysql has been installed
----
