...
In this module you’ll work with an existing Java EE application designed for a banking demo application.  The current
version of the banking app is a Java EE application built for Oracle Weblogic Application Server. As part of a modernization
...
----
https://github.com/rmarins/fsi-workshop-v2m1-labs.git
----
...
----
cd $CHE_PROJECTS_ROOT/fsi-workshop-v2m1-labs && git checkout ocp-4.5
----
...
Span `projects > fsi-workshop-v2m1-labs` then select `monolith` directory. Click on `Choose...`:

image::mta-add-opendir.png[MTA Add App, 700]

Then you will see that */projects/fsi-workshop-v2m1-labs/monoilth* directory is added in _--input_ configuration.
